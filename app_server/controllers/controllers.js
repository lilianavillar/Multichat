...
module.exports.profile = function(req, res, next) {
    res.render('profile', {
        ...
        lang: {
            ...
            age: 'Age',
            ageEnter: 'Enter your age',
            phone: 'Phone',
            phoneEnter: 'Enter your phone',
            section: 'Profile',
            submit: 'Submit',
            userName: 'User name',
            error: 'An error has been produced',
    ...
    if (req.sub == false) {
        res.render('register', {
            ...
            lang: {
                ...
                loginHere: 'Login!',
                fieldSizeCheck: 'The value must have between 3 and 20 characters',
                ageSizeCheck: 'The value must have between 18 and 99',
                phoneSizeCheck: 'The value must have 9 digits',
                checking: 'Checking...',
                name: 'Name',
                nameEnter: 'Enter your name',
                ...
                age: 'Age',
                ageEnter: 'Enter your age',
                ageRequired: 'Tell us your age',
                phone: 'Phone',
                phoneEnter: 'Enter your phone',
                phoneRequired: 'Tell us your phone',
                section: 'Register',
                submit: 'Submit',
                userName: 'User name',
                userNameEnter: 'Enter your user name',
